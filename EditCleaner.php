...
<h3>List of all cleaners</h3>
        ...
        <form action="editcleaner.php" method="post">

            <label for="cleanerid">Type Cleaner ID to edit it's data:</label>
            <input type="text" name="cleanerid" placeholder="cleanerid">
            Cleaner Name: <input type="text" name="cleanername">
            Cleaner Number: <input type="text" name="cleanernumber">
            Cleaner Salary: <input type="text" name="cleanersalary">
        ...
        if (isset($_POST['submit'])) {
            ...
            $cleanernumber = $_POST['cleanernumber'];
            $cleanersalary = $_POST['cleanersalary'];
            
           
            
            $sql = "UPDATE cleaner SET cleanername = '$cleanername', cleanernumber ='$cleanernumber', cleanersalary = '$cleanersalary' WHERE cleanerid='$cleanerid'";
