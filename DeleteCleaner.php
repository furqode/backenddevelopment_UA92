...
<h3>List of all cleaners</h3>
        ...
        <form action="Deletecleaner.php" method="post">

            <label for="deletecleaner">Cleaner ID:</label>
            <input type="text" name="deletecleaner" placeholder="Type ID to delete cleaner">
        ...
        if (isset($_POST['submit'])) {
            ...
            $deletecleaner = $_POST['deletecleaner'];
           
        
            $sql = "DELETE FROM cleaner WHERE cleanerid = '$deletecleaner'";
