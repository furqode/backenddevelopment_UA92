...
<h3>See all parents</h3>
        ...
        <form action="Deleteparent.php" method="post">
            ...
            <label for="deleteparent">Parent ID:</label>
            <input type="text" name="deleteparent" placeholder="Type ID to delete parent">
        ...
        if (isset($_POST['submit'])) {
            ...
            $deleteparent = $_POST['deleteparent'];
           
        
            $sql = "DELETE FROM parent WHERE parentid = '$deleteparent'";
