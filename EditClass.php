...
<h3>See all Classes</h3>
        ...
        <form action="editclass.php" method="post">
            ...
            <label for="classid">Type Class ID to edit it's data:</label>
            <input type="text" name="classid" placeholder="classid">
            Class Name: <input type="text" name="classname">
            Class Capacity: <input type="text" name="classcapacity">
        ...
        if (isset($_POST['submit'])) {
            ...
            $editclass = $_POST['classid'];
            $classname = $_POST['classname'];
            $classcapacity = $_POST['classcapacity'];
            $roomnumber = $_POST['room'];
           
            
            $sql = "UPDATE class SET classname = '$classname', classcapacity='$classcapacity', room = '$roomnumber' WHERE classid='$editclass'";
