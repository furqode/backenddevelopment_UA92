...
<h3>List of all Departments</h3>
        ...
        <form action="Deletedepartment.php" method="post">
            ...
            <label for="deletedepartment">Department ID:</label>
            <input type="text" name="deletedepartment" placeholder="Type ID to delete department">
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "DELETE FROM department WHERE departmentid = '$deletedepartment'";
