...
<h3>See all Classes</h3>
        ...
        <form action="deleteclass.php" method="post">
            ...
            <label for="deleteclass">Class ID:</label>
            <input type="text" name="deleteclass" placeholder="Type ID to delete class">
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "DELETE FROM class WHERE classid = '$deleteclass'";
