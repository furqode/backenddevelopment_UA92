...
<h3>See all Students</h3>
        ...
        <form action="DeleteStudent.php" method="post">
            ...
            <label for="deletestudent">Student ID:</label>
            <input type="text" name="deletestudent" placeholder="Type ID to delete student">
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "DELETE FROM student WHERE studentid = '$deletestudent'";
