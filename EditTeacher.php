...
<h3>See all Teachers</h3>
        ...
        <form action="editteacher.php" method="post">
            ...
            <label for="teacherid">Type Teacher ID to edit it's data:</label>
            <input type="text" name="teacherid" placeholder="teacherid">
            Teacher's Name: <input type="text" name="teachername">
            Teacher's Email: <input type="text" name="teacheremail">
            Teacher's Phone: <input type="text" name="teacherphone">
            Teacher's Salary: <input type="text" name="teachersalary">
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "UPDATE teacher SET teachername = '$teachername', teacheremail ='$teacheremail', teacherphone = '$teacherphone', teachersalary ='$teachersalary' WHERE teacherid='$teacherid'";
