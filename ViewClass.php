...
<h3>See all Classes</h3>
        ...
        <th width="250px">Teacher Name<br><hr></th>
			...
			*/	
			$sql = mysqli_query($link, "SELECT c.classid, c.classname, c.classcapacity, c.room, c.teacherid, t.teachername FROM class c INNER JOIN teacher t ON c.teacherid = t.teacherid");
