...
<html>
    ...
    <body>
      ...
      <div class="dropdown">
        ...
        <div>
            <br>
            <h1>Enter Cleaner Details</h1>
            <form method="post" action="AddCleaner.php">
            
            <label for="cleanername">Cleaner Name:</label>
    		<input type="text" name="cleanername">

            <label for="cleanernumber">Cleaner Number:</label>
    		<input type="text" name="cleanernumber">
            
            <label for="cleanersalary">Cleaner Salary:</label>
    		<input type="text" name="cleanersalary">
        ...
        if (isset($_POST['submit'])) {
          ...
          $cleanersalary= $_POST['cleanersalary'];
           ...
           $sql = "INSERT INTO cleaner (cleanername, cleanernumber, cleanersalary) VALUES ('$cleanername','$cleanernumber', '$cleanersalary')";
