...
<h3>List of all Departments</h3>
	
		<table>
		
			<tr>
                <th width="150px">Department ID<br><hr></th>
				<th width="250px">Department Name<br><hr></th>
                <th width="250px">Staff count<br><hr></th>
                <th width="250px">Department Building<br><hr></th>
			</tr>
			...
			*/	
			$sql = mysqli_query($link, "SELECT * FROM department");
            ...
            <th>{$row['staffcount']}</th>
            <th>{$row['departmentbuilding']}</th>
        ...
        <form action="editdepartment.php" method="post">
            ...
            <label for="departmentid">Type Department ID to edit it's data:</label>
            <input type="text" name="departmentid" placeholder="departmentid">
            Department Name: <input type="text" name="departmentname">
            Staff count: <input type="text" name="staffcount">
            departmentbuilding: <input type="text" name="departmentbuilding">
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "UPDATE department SET departmentname = '$departmentname', staffcount ='$staffcount', departmentbuilding = '$departmentbuilding' WHERE departmentid='$departmentid'";
